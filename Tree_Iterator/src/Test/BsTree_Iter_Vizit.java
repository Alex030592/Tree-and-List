...
import Task.BsTree;
import Task.BsTree_Interface;
import Task.BsTree_Viziter;

@RunWith(Parameterized.class)
public class BsTree_Iter_Vizit 
{
	BsTree_Interface obj = null;
	...
	public BsTree_Iter_Vizit(BsTree_Interface prm) 
	{
		obj = prm;
	}
